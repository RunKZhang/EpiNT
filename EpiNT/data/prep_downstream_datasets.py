...
from .dataset_list import DATASETS_PATH
from .chb_mit_data_handler import *
...
class CUK_IMHANS:
    ...
    def __init__(self, hd5dataset):
        self.path = DATASETS_PATH['CUK_IMHANS']
...
class Zenodo_neonatal:
    # Seizure detection
    def __init__(self, hd5dataset):
        self.path = DATASETS_PATH['Zenodo_neonatal']
    ...
    def _process_data(self):
        ...
        for patient in patients:
            ...
            for edf_file in seizures_with["file_name"]:
                ...
                raw_seiz = raw_seiz.copy().pick(get_features()).resample(new_sfreq)
                ...
                if seizure_time[0][0] - 8*60 >= 0:                    
                    ...
                    raw_pre = raw_pre.copy().pick(get_features()).resample(new_sfreq)
...
class SOZ_LOC:
    # soz localization
    def __init__(self, hd5dataset):
        self.path = DATASETS_PATH['iEEG_bids_figshare']
