...
class Pretrain(Base):
    def __init__(self, args):
        ...
        # self.criterion = self._select_criterion(loss_type="mse", reduction="mean")
    ...
    def train(self):
        ...
        while opt_steps < self.args.max_opt_steps and cur_epoch < self.args.max_epoch:
            ...
            for _, batch_x in enumerate(self.train_dataloader):
                ...
                self.accelerator.log({"train_loss": loss, 
                                      "learning_rate": self.optimizer.param_groups[0]["lr"],
                                      "gradient_norm": gradient_norm
                                      }, step=opt_steps, log_kwargs={"aim": {"epoch": cur_epoch}})
                ...
                if opt_steps % self.args.interval == 0 and opt_steps != 0:
                    ...
                    self.accelerator.log({"eval_loss": eval_loss
                                          }, step=opt_steps, log_kwargs={"aim": {"epoch": cur_epoch}})
