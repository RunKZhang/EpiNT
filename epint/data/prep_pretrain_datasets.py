...
class OpenNeuro(PretrainDatasetBase):
    ...
    def __init__(self, dataset_name, hd5dataset, datasets_config):
        super().__init__(dataset_name, hd5dataset, datasets_config)
        self.files_list = []
