...
from ..data.make_datasets import create_dataloaders, create_downstream_dataloaders
from ..model.EpiNTModel import EpiNT
# from EpiNT.models.EpiNT_ablation import EpiNT_ablation
from ..utils.optmis import LinearWarmupCosineLRScheduler
...
to_be_load_dict = {
    ...
    'EpiNT': ['embed', 'transformer_encoder', 'norm'],
}

backbone_prefix = {
    'EEPT': 'transformer_encoder',
    'EEPT_ablation': 'transformer_encoder',
    'EpiNT': 'transformer_encoder',
}